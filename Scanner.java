    ...
    public TokenInfo getNextToken() {
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if (ch == '/') {
                    ...
                    nextCh();
                    // Goes to the whole file
                    while (ch != EOFCH) {
                        // Looks for "*"
                        if (ch == '*') {
                            nextCh();
                            // Leaves the loop if "/" is found after a "*"
                            if (ch == '/') {
                                break;
                            }
                            else {
                    ...
                    // Return Division only if a "/" is found
        ...
        case '|':
            ...
            if (ch == '=') {
                ...
                nextCh();
                return new TokenInfo(DOUBLE_IOR, line);
            } else {
        ...
        case '>':
            ...
            if (ch == '=') {
                ...
                if (ch == '=') {
                    ...
                    if (ch == '=') {
                        nextCh();
                        return new TokenInfo(LogicalRShift_ASSIGN, line);
                    } else {
                        return new TokenInfo(LogicalRShift, line);
                    }
                } else {
        ...
        case '.':
            ...
            buffer.append(ch);
            nextCh();
            // Look for a number to follow after the "."
            if (isDigit(ch)) {
                // Keep the loop going as long as a number is found 
                while (isDigit(ch)) {
                    buffer.append(ch);
                    nextCh();
                    // Look for a "D" or "d" 
            ...
            while (isDigit(ch)) {
                ...
                // Looks for a "e" or "E"
                    ...
                    if (ch == '+' || ch == '-') {
                        buffer.append(ch);
                        nextCh();
                        // Keep the going as long as a digit is found 
                        while (isDigit(ch)) {
                            buffer.append(ch);
                            nextCh();
                            // Look for a "D" or "d"
                ...
                // Looks for a "."
                    ...
                    if (ch == 'e' || ch == 'E') {
                        ...
                        if (ch == '+' || ch == '-') {
                            buffer.append(ch);
                            nextCh();
                            // Keep going as long as the character is a digit 
                            while (isDigit(ch)) {
                                buffer.append(ch);
                                nextCh();
                                // Look for a "D" or "d"
